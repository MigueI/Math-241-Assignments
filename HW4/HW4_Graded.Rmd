...
* Achievement, mastery, cleverness, creativity: check+++++
* Ease of access for instructor: did not compile.  You forgot to include nine nations.png
* Demonstration of statistical understanding: check+++++


Please indicate:

* Approximately how much time you spent on this homework: ~ 15 hours
* What, if anything, gave you an exceeding amount of trouble?  By exceeding I mean above and beyond run-of-the-mill difficulties when learning new things.  gcplibPermit() killed me. It took me a while to get shiny running properly, errors with as.character etc. Part of the reason it took so long was because things took a long time to compile, since all of the data sets were pretty large.  
...
* GREAT JOB recognizing the outlier!  Yes, it is distorting the entire scale!
* I would thin the border lines of the census tracts because they it hard to see what's going on <----- I wrote this before I saw your very next plot.  Good zoom in!
* I guess the product works.  I was thinking more a regression, where we plot the residuals.  i.e. after controlling for income, are the seattle counties still have high values?
* Wow Miguel, you're not going to believe this.  but I have the very same plot in a paper I submitted to a biostatistics journal. Let me show you.   
* GREAT job with the ANOVA.  
...
* Wow, it is much better with the white than the purple.  Good job not listening to me!  
* You made a crucial error however!  You joined only on county name, but there are 32 Washington counties in the US!  How do you know you are matching the right one?  Got to join on state-county name to ensure uniqueness.  
* A table might have done the job just as well in terms of showing the SD's.

COMMENTS ON Q3:

* Unbelievable.  I'm absolutely floored.  It's been a privedge teaching.  I'm so glad you talked me into letting you register for this class.  
...
I only included years 2006-2014 so that I could upload it [here](https://miguelconner4.shinyapps.io/PDX_Crime). **Please note** that the shiny app (PDX_Crime.Rmd) runs with a single data set called "crime_data.csv",  which I have uploaded with my HW. 
